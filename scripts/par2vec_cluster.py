...
kmeans_c = MiniBatchKMeans(n_clusters=len(book_filenames), batch_size=100000, random_state=0).fit(centered_vecs)

np.savetxt("../models/kmeans_c_labels.csv", kmeans_c.labels_, delimiter=",")
np.savetxt("../models/kmeans_c_cluster_centers.csv", kmeans_c.cluster_centers_, delimiter=",")
